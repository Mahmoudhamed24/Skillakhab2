    ...
    card.innerHTML = `
      ...
      <div class="card" style="border-radius:18px;overflow:hidden;margin-bottom:14px">
        ...
        <div class="cb" style="padding:0;overflow:auto;max-height:360px">
          <table class="dtbl" style="min-width:980px"><thead><tr><th>الاسم</th><th>البريد</th><th>الدور</th><th>الحالة</th><th>التقييم</th><th>الجلسات</th><th>الرصيد</th></tr></thead><tbody>
